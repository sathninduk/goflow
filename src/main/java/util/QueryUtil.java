...
public class QueryUtil extends CommonUtil {
	 ...
	 public QueryUtil() {
	    ...
	    public static String queryByID(String id) throws SAXException, IOException, ParserConfigurationException {
			...
			NodeList nodeList = DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new File("C:\\Users\\User\\Documents\\GitHub\\goflow\\src\\main\\webapp\\WEB-INF\\Query\\Query.xml")).getElementsByTagName("query");
