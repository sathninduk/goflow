...
public class QueryUtil extends CommonUtil {
	 ...
	 public QueryUtil() {
	    ...
	    public static String queryByID(String id) throws SAXException, IOException, ParserConfigurationException {
			...
			// server
			//NodeList nodeList = DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new File("/opt/tomcat/webapps/goflow_Web/WEB-INF/Query/Query.xml")).getElementsByTagName("query");
